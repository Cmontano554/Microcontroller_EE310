...
int x_reg __attribute__((address(0x01)));
int y_reg __attribute__((address(0x03)));
int op_reg __attribute__((address(0x05)));
signed char display_reg __attribute__((address(0x07)));
...
void op() {
    ...
    while (b<1) {
        PORTBbits.RB3 = 1;
        if (PORTBbits.RB4 == 1) op_reg = 1, b = b+1;
        else if (PORTBbits.RB5 == 1) op_reg = 2, b = b+1;
